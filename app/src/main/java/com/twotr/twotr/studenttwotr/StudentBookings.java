...
import com.twotr.twotr.tutorfiles.Schedule_history_list;
...
public class StudentBookings extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_student_bookings, container, false);
        ...
        schedule_list_url = "http://twotr.com:5040/api/class/upcoming/student?page=1&size=10" ;
        ...
        Bhistory.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                schedule_list_url_history = "http://twotr.com:5040/api/class/history/student?page=1&size=10" ;
...
//upcominglist(upcoming_url);
        ...
        LVschedule_history.setOnScrollListener(new EndlessScrollListener() {
            ...
            public void onLoadMore(int page, int totalItemsCount) {
                ...
                schedule_list_url_history = "http://twotr.com:5040/api/class/history/student?page="+page+"&size=10" ;
        ...
        LVschedule.setOnScrollListener(new EndlessScrollListener() {
            ...
            public void onLoadMore(int page, int totalItemsCount) {
                ...
                schedule_list_url = "http://twotr.com:5040/api/class/upcoming/student?page="+page+"&size=10" ;
    ...
    public class ScheduleAsyncList extends AsyncTask<String, String, List<Schedule_upcoming_list>> {
        ...
        protected List<Schedule_upcoming_list> doInBackground(String... params) {
            ...
            try {
                ...
                JSONArray parentArray = parentObject.getJSONArray("schedules");
