...
import com.twotr.twotr.guestfiles.MyFabFragment;
import com.twotr.twotr.guestfiles.guestfilterrows;
 ...
 */
public class StudentDashboard extends Fragment implements AAH_FabulousFragment.Callbacks, AAH_FabulousFragment.AnimationListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        listViewguest=view.findViewById(R.id.guset_subfil);
        ETsubject_name=view.findViewById(R.id.subject_name);
    ...
    public class ScheduleAsyncList extends AsyncTask<String, String, List<Guest_list_parce>> {
        ...
        protected void onPostExecute(final List<Guest_list_parce> ScheduleMode) {
            ...
            if ((ScheduleMode != null) && (ScheduleMode.size()>0)&& getActivity()!=null)
            {
                ...
                tutorpageadapter = new Schedule_class(getActivity(), R.layout.guest_dasboard_list, ScheduleMode);
                ...
                listViewguest.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                    ...
                    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                        ...
                        Intent intent = new Intent(getActivity(), GuestActivityDetails.class);
...
//                    }
        ...
        protected void onPostExecute(final List<Guest_list_parce> ScheduleMode) {
            ...
            if ((ScheduleMode != null) && (ScheduleMode.size()>0))
            {
                ...
                //    tutorpageadapter = new Schedule_class(this, R.layout.guest_dasboard_list, ScheduleMode);
...
////                            Intent intent = new Intent(this, ScheduleDetailPage.class);
