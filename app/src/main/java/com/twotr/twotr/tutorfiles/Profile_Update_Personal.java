...
public class Profile_Update_Personal extends AppCompatActivity implements DatePickerDialog.OnDateSetListener {
    ...
    Button Bsaveconti;
    public String Sid,Stoken,Smiddlename,Sfirstname,Slastname;
...
String Surl;
    ...
    String Sdob,Sgender,Stimezone,Ssubjectkind,Smcode,Smobile_number,Saddline,Saddcity,Scode,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        context = Profile_Update_Personal.this;
        ...
        if(Bintent != null)
        {
            Sfirstname = (String) Bintent.get("firstname");
            Slastname = (String) Bintent.get("lastname");
            Sgender=(String) Bintent.get("gender");
            Sdob=(String) Bintent.get("dob");
            Saddline=(String) Bintent.get("addres");
            Sdecription=(String) Bintent.get("descrip");
...
//        tgps = new TrackGPS(Profile_Update_Personal.this);
...
//        }
        ...
        Bsaveconti.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                if (et_per_fname.getText().toString().equals(""))
                {
                    ...
                    new SweetAlertDialog(Profile_Update_Personal.this, SweetAlertDialog.NORMAL_TYPE).setTitleText(sweetmessage)
                            .setConfirmText("OK")
        ...
        TVsubject.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(Profile_Update_Personal.this, MultiSubjectSpinner.class);
...
////
////                                    .build(Profile_Update_Personal.this);
////
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, Global_url_twotr.Profile_timezone, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                try {
                    ...
                    SStime_zone.setAdapter(new ArrayAdapter<String>(Profile_Update_Personal.this, android.R.layout.simple_dropdown_item_1line, AStime_zone));
                    //  SSmobilepin.setAdapter(new ArrayAdapter<String>(Profile_Update_Personal.this, android.R.layout.simple_dropdown_item_1line, AStime_zone));
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, Global_url_twotr.Profile_countrycode, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                try {
                    ...
                    // SStime_zone.setAdapter(new ArrayAdapter<String>(Profile_Update_Personal.this, android.R.layout.simple_dropdown_item_1line, AStime_zone));
                    SSmobilepin.setAdapter(new ArrayAdapter<String>(Profile_Update_Personal.this, android.R.layout.simple_dropdown_item_1line, ASmobile_zone));
    ...
    public void personal_profile(String sdob, String sgender, String stimezone, String sgrade, Boolean scantutor, String smcode, String smobile_number, String saddline, String saddcity, String saddstate, String scountry, String sdefaultcountry, String sdecription)
    {
        try {
            ...
            StringRequest stringRequest = new StringRequest(Request.Method.POST, Profile_update_url, new Response.Listener<String>() {
                ...
                public void onResponse(String response) {
                    avi.hide();
                    startActivity(new Intent(Profile_Update_Personal.this,HomePage.class));
                    finish();
                }
            }, new Response.ErrorListener() {
                @Override
                public void onErrorResponse(VolleyError error) {
                    ...
                    if (networkResponse != null && networkResponse.data != null) {
                        try {
                            ...
                            if (message.equals("invalid_token"))
                            {
                                ...
                                Volley.newRequestQueue(Profile_Update_Personal.this).add(jsonRequest);
                    ...
                    new SweetAlertDialog(Profile_Update_Personal.this, SweetAlertDialog.WARNING_TYPE).setTitleText("Server Error")
                            .setConfirmText("OK")
                            .setConfirmClickListener(new SweetAlertDialog.OnSweetClickListener() {
                                @Override
                                public void onClick(SweetAlertDialog sweetAlertDialog) {
