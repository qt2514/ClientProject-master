        ...
        IVaddsch.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                new SpotlightView.Builder(getActivity())
                        ...
                        .subHeadingTvSize(16)
                        .subHeadingTvText("Add you available date and time for tutoring session")
        ...
        IVaddminamout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                new SpotlightView.Builder(getActivity())
                        ...
                        .subHeadingTvColor(Color.parseColor("#ffffff"))
                        .subHeadingTvSize(16)
                        .subHeadingTvText("Minimum amount acceptable for entire group to be distributed \nevenly among all registered students")
                        .maskColor(Color.parseColor("#dc000000"))
                        .target(ETminamount)
                        .lineAnimDuration(300)
                        .lineAndArcColor(Color.parseColor("#eb273f"))
        ...
        IVaddmap.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                new SpotlightView.Builder(getActivity())
                        ...
                        .subHeadingTvColor(Color.parseColor("#ffffff"))
                        .subHeadingTvSize(16)
                        .subHeadingTvText("Add your session location for students to find it easily")
                        .maskColor(Color.parseColor("#dc000000"))
                        .target(TVaddmap)
                        .lineAnimDuration(300)
                        .lineAndArcColor(Color.parseColor("#eb273f"))
