...
public class Profile_update_educational extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_profile_update_educational);
       ...
       // textViewskipedu=findViewById(R.id.skip_edu);
        ...
        if(Bintent != null)
        {
            ...
            Smajor = (String) Bintent.get("smajor");
            Sinstitution = (String) Bintent.get("sinstitution");
            SfieldOfStudy=(String) Bintent.get("sfieldOfStudy");
            SstartYear=(String) Bintent.get("sstartYear");
            SendYear=(String) Bintent.get("sendYear");

        }
        textViewedu.setText(Smajor);
        textViewins.setText(Sinstitution);
        et_edu_startd.setText(SstartYear);
        et_edu_enddate.setText(SendYear);
...
//                {
//                    startActivity(new Intent(Profile_update_educational.this, HomePage.class));
//                    finish();
//                }
//                else {
//                    startActivity(new Intent(Profile_update_educational.this, StudentHome.class));
//                    finish();
//                }
//
//            }
//        });
        searchboxedu.setMenuListener(new SearchBox.MenuListener(){
            ...
            public void onMenuClick() {
                ...
                Toast.makeText(Profile_update_educational.this, "Menu click", Toast.LENGTH_LONG).show();
            }
        ...
        Bsaveandconti.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (textViewedu.getText().toString().equals(""))
                {
                    ...
                    new SweetAlertDialog(Profile_update_educational.this, SweetAlertDialog.NORMAL_TYPE).setTitleText(sweetmessage)
                            .setConfirmText("OK")
...
//                                    {
        ...
        et_edu_startd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                MonthPickerDialog.Builder builder = new MonthPickerDialog.Builder(Profile_update_educational.this, new MonthPickerDialog.OnDateSetListener() {
